...
JavaUtilLoggingLogger * GDCWebSocketBus_log_;

+ (NSString *)PING_INTERVAL {
  return GDCWebSocketBus_PING_INTERVAL_;
}

+ (NSString *)BODY {
  return GDCWebSocketBus_BODY_;
}

+ (NSString *)ADDRESS {
  return GDCWebSocketBus_ADDRESS_;
}

+ (NSString *)REPLY_ADDRESS {
  return GDCWebSocketBus_REPLY_ADDRESS_;
}

+ (NSString *)TYPE {
  return GDCWebSocketBus_TYPE_;
}

+ (JavaUtilLoggingLogger *)log {
  return GDCWebSocketBus_log_;
}
...
- (void)sendWithNSString:(NSString *)msg {
  if (state_ == GDCStateEnum_get_OPEN()) {
    ...
    [((JavaUtilLoggingLogger *) nil_chk(GDCWebSocketBus_log_)) warningWithNSString:[NSString stringWithFormat:@"WebSocket is in %@ state. Cannot send: %@", state_, msg]];
  }
}
...
+ (void)initialize {
  if (self == [GDCWebSocketBus class]) {
    GDCWebSocketBus_log_ = [JavaUtilLoggingLogger getLoggerWithNSString:[[IOSClass classWithClass:[GDCWebSocketBus class]] getName]];
...
+ (J2ObjcClassInfo *)__metadata {
  ...
  static J2ObjcFieldInfo fields[] = {
    ...
    { "log_", NULL, 0x1a, "Ljava.util.logging.Logger;", &GDCWebSocketBus_log_,  },
